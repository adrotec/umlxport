...
use Adrotec\UmlXport\Doctrine\MongoDB\MappingConverter;
...
class UmlExporter {
    ...
    public function export(UmlClass $umlClass, $format = null){
        ...
        $documentGenerator = new \Doctrine\ODM\MongoDB\Tools\DocumentGenerator();
        
        return $documentGenerator->generateDocumentClass($classMetaInfo);
